...
<html>
	<head>
		...
		<title>Magz &mdash; Free Responsive HTML5 &amp; CSS3 Magazine Template</title>
	...
	<body>
		<div class="topbar">
			<div class="container">
				<div class="inner">
					<div class="left">
						<ul class="info">
							<li><a href="mailto:hi@kodinger.com"><i class="ion-ios-email-outline"></i> hi@kodinger.com</a></li>
						</ul>
					</div>
					<div class="right">
						<ul class="topbar-nav">
							<li class="active"><a href="index.php"><i class="ion-ios-home-outline"></i> Home</a></li>
							<li><a href="#"><i class="ion-ios-people-outline"></i> Partner</a></li>
							<li><a href="contact.php"><i class="ion-ios-email-outline"></i> Contact</a></li>
							<li><a href="page.php"><i class="ion-ios-help-outline"></i> About</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<header class="primary">
			<div class="container">
				<div class="brand">
					...
					<h2>
						Free <br>Responsive <br> HTML5 &amp; CSS3 <br> Magazine Template
					</h2>
				</div>
		...
		<nav class="menu">
			<div class="container">
				<ul>
					<li><a href="category.php">How To <div class="badge">New!</div></a></li>
					<li><a href="category.php">Lifestyle</a></li>
					<li><a href="category.php">Political</a></li>
					<li><a href="category.php">Healthy</a></li>
					<li class="magz-dropdown"><a href="category.php">Computer <i class="ion-ios-arrow-right"></i></a>
						<ul>
							<li><a href="category.php">Internet</a></li>
							<li class="magz-dropdown"><a href="category.php">Troubleshoot <i class="ion-ios-arrow-right"></i></a>
								<ul>
									<li><a href="category.php">Software</a></li>
									<li class="magz-dropdown"><a href="category.php">Hardware <i class="ion-ios-arrow-right"></i></a>
										<ul>
											<li><a href="category.php">Child Menu 1</a></li>
											<li><a href="category.php">Child Menu 2</a></li>
											<li><a href="category.php">Child Menu 3</a></li>
										</ul>
									</li>
									<li><a href="category.php">Menu 3</a>
								</ul>
							</li>
							<li><a href="category.php">Office</a></li>
						</ul>
					</li>
					<li><a href="category.php">International</a></li>
					<li><a href="category.php">Film</a></li>
					<li><a href="category.php">Entertainment</a></li>
					<li><a href="category.php">Travel</a></li>
					<li><a href="category.php">Sport</a></li>
					<li><a href="category.php">Religion</a></li>
				</ul>
			</div>
		</nav>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="page-subtitle">Get more elements</p>
						...
						<div class="page-description">
									...
									<div class="element-block">
										...
										<div class="element-body">
											...
											<ul class="magz-list">
												...
												<li><span class="font-roboto">Roboto</span></li>
							...
							<div class="row">
											...
											<div class="row" style="margin-top: 30px;">
												<div class="col-md-12">
													<div class="element-block">
														...
														<div class="element-body">
															<span class="bold">Line Hover</span>
	                            <ul class="social trp">
	                                <li>
	                                    <a href="" class="facebook">
	                                        <svg><rect/></svg>
	                            ...
	                            <span class="bold">.btn-social</span>
	                            <div>
											...
											<div class="row" style="margin-top: 30px;">
												<div class="col-md-12">
													<div class="element-block">
														...
														<div class="element-body">
															<span class="bold">I want to say thank you very much to those who have made a cool plugins that used in Magz.</span>
															<ul class="magz-list square">
																...
																<li>Touchswipe by <a href="https://github.com/mattbryson/TouchSwipe-Jquery-Plugin" target="_blank">@mattbryson</a></li>
																...
																<li>Font: Roboto by <a href="https://fonts.google.com/specimen/Roboto" target="_blank">Christian Robertson</a></li>
											...
											<div class="row" style="margin-top:50px;">
												<div class="col-md-12">
													<div class="text-center" style="font-size: 20px">
														<span class="bold">Have a question?</span> &nbsp;&nbsp;<a href="mailto: hi@kodinger.com" class="btn btn-magz" style="text-transform: uppercase; font-weight: 300;">We Hear You</a>
													</div>
												</div>
											</div>
										</div>
		...
		<footer class="footer">
			<div class="container">
						...
						<div class="block">
							...
							<div class="block-body">
								...
								<p class="brand-description">
									Magz is a free HTML5 &amp; CSS3 magazine template is based on Bootstrap 3. This template is free for personal or commercial use.
								</p>
								<a href="page.php" class="btn btn-primary btn-magz white">About Us <i class="ion-ios-arrow-thin-right"></i></a>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="block">
							...
							<div class="block-body">
								...
								<a href="#" class="btn btn-primary btn-magz white btn-block">See All <i class="ion-ios-arrow-thin-right"></i></a>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-xs-12 col-sm-6">
						<div class="block">
							...
							<div class="block-body">
								...
								<ul class="social trp">
									<li>
										<a href="https://facebook.com/ThisKodinger" class="facebook">
											<svg><rect/></svg>
											<i class="ion-social-facebook"></i>
										</a>
									</li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="copyright">
							Copyright &copy; Magz 2016. All Right Reserved.
							<div>
