					...
					<div id="menu-list">
						<ul class="nav-list">
							...
							<li class="dropdown magz-dropdown">
								<a href="category.php">Pages <i class="ion-ios-arrow-right"></i></a>
							...
							<li class="dropdown magz-dropdown"><a href="#">Dropdown <i class="ion-ios-arrow-right"></i></a>
								<ul class="dropdown-menu">
									...
									<li class="dropdown magz-dropdown"><a href="category.php">Troubleshoot <i class="ion-ios-arrow-right"></i></a>
										<ul class="dropdown-menu">
											<li><a href="category.php">Software</a></li>
											<li class="dropdown magz-dropdown"><a href="category.php">Hardware <i class="ion-ios-arrow-right"></i></a>
												<ul class="dropdown-menu">
													<li><a href="category.php">Main Board</a></li>
													<li><a href="category.php">RAM</a></li>
													<li><a href="category.php">Power Supply</a></li>
												</ul>
											</li>
											<li><a href="category.php">Brainware</a>
										</ul>
									</li>
									<li><a href="category.php">Office</a></li>
									<li class="dropdown magz-dropdown"><a href="#">Programming <i class="ion-ios-arrow-right"></i></a>
										<ul class="dropdown-menu">
											<li><a href="category.php">Web</a></li>
											<li class="dropdown magz-dropdown"><a href="category.php">Mobile <i class="ion-ios-arrow-right"></i></a>
												<ul class="dropdown-menu">
													<li class="dropdown magz-dropdown"><a href="category.php">Hybrid <i class="ion-ios-arrow-right"></i></a>
														<ul class="dropdown-menu">
													...
													<li><a href="category.php">Native</a></li>
												</ul>
											</li>
											<li><a href="category.php">Desktop</a></li>
										</ul>
									</li>
								</ul>
							</li>
													...
													<article class="article col-md-4 mini">
														<div class="inner">
															...
															<div class="padding">
																...
																<h2><a href="single.php">Duis aute irure dolor in reprehenderit in voluptate</a></h2>
															</div>
														</div>
													</article>
													<article class="article col-md-4 mini">
